...
-- Populate Faculty
--insert into faculty(id,name,title) values (1,'Faculty','Compro');
--insert into faculty(id,name,title) values (2,'Gideon','MBA');
--insert into faculty(id,name,title) values (3,'Philip','Civil Engineering');
